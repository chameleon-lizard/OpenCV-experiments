...
*P.S. Я тут подумал, видео из примера в 30 кадрах в секунду в 720p. В конце, где я ручкой машу, там есть кадры с низким качеством распознавания. Может быть, если воспользоваться пирамидкой (снизить разрешение входных кадров, чтобы перемещение пикселей было меньше), качество распознавания будет лучше?*
